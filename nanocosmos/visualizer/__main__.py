"""
CLI entry point: ``python -m nanocosmos.visualizer --raw vol.h5 --seg seg.h5``
...
def main() -> None:
    ...
    from nanocosmos.visualizer.volume_loader import load_volume
    from nanocosmos.visualizer.app import app, _store, _VolumeEntry, _build_palette
